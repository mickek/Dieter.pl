...
class Migration:
    ...
    def forwards(self, orm):
        db.create_index("patients_userdata",["date","user_id"], unique=True)
    
    def backwards(self, orm):
        db.delete_index("patients_userdata",["date","user_id"], unique=True)
    ...
    models = {
        ...
        'auth.user': {
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2009, 9, 3, 8, 26, 1, 198602)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2009, 9, 3, 8, 26, 1, 198476)'}),
